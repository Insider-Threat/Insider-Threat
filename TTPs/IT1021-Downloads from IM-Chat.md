...
## **Overview:**
A lot of sensitive information is shared via Instant Message/Chat, when data transfers occur, that are abnormal to a users normal behavior, it may be an indication that the user is staging data or in the process of transferring data.
