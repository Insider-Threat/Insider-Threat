...
## **Overview:**
When bulk data transfers occur, that are abnormal to a users normal behavior, it may be an indication that the user is staging data or in the process of transferring data.
